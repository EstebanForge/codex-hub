...
*   The `on click` is an [event handler feature](https://hyperscript.org/features/on)
...
You can also [add your own conversions](https://hyperscript.org/expressions/as) to the language as well.
